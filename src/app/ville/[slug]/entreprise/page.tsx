...
export async function generateMetadata({
    ...
    return {
        ...
        openGraph: {
            ...
            images: [{
                url: ogImageUrl({ q: site.city, sub: "Bornes pour entreprises, flottes et parkings" }),
                width: 1200,
                height: 630,
                alt: `Bornes de recharge entreprise à ${site.city}`,
            }],
        },
        twitter: {
            ...
            title: b2bContent.meta_title,
            description: b2bContent.meta_description,
            images: [ogImageUrl({ q: site.city, sub: "Bornes pour entreprises, flottes et parkings" })],
        },
