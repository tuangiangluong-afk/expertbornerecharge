...
import { Phone, CheckCircle, ArrowRight, Car, ShieldCheck, Clock } from "lucide-react";
...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
    ...
    return {
        ...
        alternates: {
            canonical: `https://taxifrance.fr/service/${resolvedParams.slug}`, // Canonical to "service" path, not root shortcut to avoid confusion
        }
    };
}
