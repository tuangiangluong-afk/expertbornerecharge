            ...
            <section className="pt-32 pb-12 lg:pt-40 lg:pb-20 px-6 bg-white overflow-hidden relative">
                ...
                <div className="mx-auto max-w-4xl text-center relative z-10">
                    ...
                    <h1 className="text-4xl md:text-6xl font-black tracking-tighter mb-6 text-slate-900">
                        Un projet de <span className="text-blue-600">recharge</span> ?
                    </h1>
            ...
            <section className="pb-20 px-6">
                <div className="mx-auto max-w-6xl">
                    <div className="grid md:grid-cols-3 gap-8 mb-16 -mt-8">
                        {/* Card 1: Commercial */}
                        <div className="bg-white rounded-2xl p-8 shadow-xl shadow-slate-200/50 border border-slate-100 hover:border-blue-200 transition text-center group">
                            <div className="mx-auto w-14 h-14 bg-blue-50 rounded-2xl flex items-center justify-center mb-6 text-blue-600 group-hover:scale-110 transition duration-300">
                                <Phone size={28} />
                            </div>
                        ...
                        <div className="bg-white rounded-2xl p-8 shadow-xl shadow-slate-200/50 border border-slate-100 hover:border-blue-200 transition text-center group">
                            ...
                            <p className="font-bold text-slate-900">Expert Borne Recharge</p>
                        </div>
                    </div>
                    ...
                    <div className="grid lg:grid-cols-5 gap-12">
                        ...
                        <div className="lg:col-span-2 space-y-8">
                            <div>
                                ...
                                <ul className="space-y-4">
                                    {[
                                        "Réseau national d'installateurs certifiés IRVE",
                                        "Accompagnement de A à Z (devis, aides, installation)",
                                        "Solutions pour maisons, copropriétés et entreprises",
                                        "Matériel de qualité (Wallbox, Schneider, Hager...)"
                                    ].map((item, i) => (
                            ...
                            <div className="p-6 bg-blue-50 rounded-2xl border border-blue-100">
                                <h4 className="font-bold text-blue-900 mb-2">Vous êtes installateur ?</h4>
                                <p className="text-sm text-blue-700 mb-4">Rejoignez le 1er réseau d'apporteurs d'affaires qualifiés en France.</p>
                                <Link href="#form" className="text-sm font-bold text-blue-600 hover:underline flex items-center gap-1">
                        ...
                        <div id="form" className="lg:col-span-3 bg-white rounded-3xl p-8 md:p-10 shadow-2xl border border-slate-100">
                            ...
                            <ContactForm domain="expertbornerecharge.com" city="Hub National" theme={getTheme('national')} />
                        </div>
                    </div>
                </div>
            </section>
